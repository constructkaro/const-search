...
@section('title', 'BOQ / Estimation Order Tracking')
            ...
            <div class="tracking-box orange-theme">
                <div class="tracking-steps">
                    ...
                    <div class="tracking-step-row locked">
                        ...
                        <div>
                            <div class="track-card">
                                <h4>Please review your chosen BOQ / estimation option before proceeding.</h4>
                                <div class="action-row">
                    ...
                    <div class="tracking-step-row locked">
                        ...
                        <div>
                            <div class="track-card">
                                <h4>Would you like to proceed with this estimation service?</h4>
                                <div class="action-row">
                                    <button type="button" class="mini-btn orange">Yes</button>
                                    <button type="button" class="mini-btn light">No</button>
                                </div>
            ...
            <div class="tracking-box blue-theme">
                <div class="tracking-steps">
                    ...
                    <div class="tracking-step-row pending-blue">
                        ...
                        <div>
                            <div class="track-card">
                                <h4>Your site visit is being scheduled for measurement and project assessment.</h4>
                    ...
                    <div class="tracking-step-row pending-blue">
                        <div class="step-left">
                            <div class="step-icon-wrap">
                                <div class="step-icon">
                                    <svg viewBox="0 0 24 24">
                                        <path d="M12 2a5 5 0 00-5 5c0 3.2 2.2 5.8 5 9 2.8-3.2 5-5.8 5-9a5 5 0 00-5-5zm0 7a2 2 0 110-4 2 2 0 010 4zM7 20h10v2H7z"></path>
                                    </svg>
                                </div>
                                <div class="step-line"></div>
                            </div>
                        ...
                        <div>
                            <div class="track-card">
                                <h4>Your site visit and measurement have been completed successfully.</h4>
                                <div class="status-row">
                                    <div class="track-status completed">◦ Completed</div>
                                    <div class="track-status pending">◦ Pending</div>
                                </div>
                    ...
                    <div class="tracking-step-row pending-blue">
                        <div class="step-left">
                            <div class="step-icon-wrap">
                                <div class="step-icon">
                                    <svg viewBox="0 0 24 24">
                                        <path d="M6 2h12v20H6zm2 2v16h8V4zm1 3h6v2H9zm0 4h6v2H9zm0 4h4v2H9z"></path>
                                    </svg>
                                </div>
                                <div class="step-line"></div>
                            </div>
                        ...
                        <div>
                            <div class="track-card">
                                <h4>Your detailed BOQ and cost estimation are being prepared.</h4>
                                <div class="status-row">
                                    <div class="track-status completed">◦ Completed</div>
                                    <div class="track-status pending">◦ Pending</div>
                                </div>
                    ...
                    <div class="tracking-step-row locked">
                        ...
                        <div>
                            <div class="track-card">
                                <h4>Your detailed BOQ report is ready for download.</h4>
                                <div class="status-row">
                                    <div class="track-status completed">◦ Completed</div>
                                    <div class="track-status pending">◦ Pending</div>
                                </div>
